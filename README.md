...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd, "SUBRAMANIYA PILLAI B");
  while (1)
  {
	  for (int x=1;x<=200;x++)
	  	  {
...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/Saravana-Kumar07/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94303546/d33d19d8-0124-4f21-83ad-50f1c4530c11)
